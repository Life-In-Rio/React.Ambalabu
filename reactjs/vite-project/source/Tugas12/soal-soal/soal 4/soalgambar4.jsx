...
import { createBrowserRouter, RouterProvider, Outlet, NavLink, useParams } from "react-router-dom";
...
function ProfilePage() {
    ...
    return (
        <div className="text-center mt-10">
            ...
            <p className="text-lg">ID Pengguna: <span className="font-mono text-blue-500">{userId}</span></p>
        </div>
    );
}
